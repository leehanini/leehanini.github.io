...
pygame.mixer.music.load("boynextdoor.mp3")  # Ganti dengan nama file audio yang ingin diputar
pygame.mixer.music.play(-1, 0.0)  # -1 berarti audio akan diputar berulang-ulang, 0.0 adalah mulai dari awal

t = turtle.Turtle()
t.pensize(4)
t.shape("turtle")
turtle.bgpic("leehan.gif")
